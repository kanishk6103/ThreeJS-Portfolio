...
// template_ur58upe     //template ID
// service_v1gu2zb      //service ID
// CDI6OJyM_iM9naGCr    //public key
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_ur58upe',
      {
        ...
        to_email: 'tkanishk6103@gmail.com',
      ...
      .then(() => {
        setLoading(false);
        alert('Thanks for contacting. I will contact you as soon as I find time!');
        setForm({
          name: '',
          email: '',
          message: '',
